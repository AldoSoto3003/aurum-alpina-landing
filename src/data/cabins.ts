...
export const cabins: Cabin[] = [
  {
    ...
    size:"55",
    images: [
      "../src/assets/imgs/alpina/alpina_1.jpg",
      "../src/assets/imgs/alpina/alpina_2.jpg",
      "../src/assets/imgs/alpina/alpina_3.jpg",
      "../src/assets/imgs/alpina/alpina_4.jpg",
      "../src/assets/imgs/alpina/alpina_5.jpg",
    ],
    distribution: [
      "1 Recamara",
      "1 Mezzanine",
  ...
  },
  {
    ...
    size:"71",
    images: [
      "../src/assets/imgs/aurum/aurum_1.jpg",
      "../src/assets/imgs/aurum/aurum_2.jpg",
      "../src/assets/imgs/aurum/aurum_3.jpg",
      "../src/assets/imgs/aurum/aurum_4.jpg",
      "../src/assets/imgs/aurum/aurum_5.jpg",
    ],
    distribution: [
  ...
  },
  {
    ...
    size:"83",
    images: [
      "../src/assets/imgs/brisa/brisa_1.jpg",
      "../src/assets/imgs/brisa/brisa_2.jpg",
      "../src/assets/imgs/brisa/brisa_3.jpg",
      "../src/assets/imgs/brisa/brisa_4.jpg",
      "../src/assets/imgs/brisa/brisa_5.jpg",
    ],
    distribution: [
